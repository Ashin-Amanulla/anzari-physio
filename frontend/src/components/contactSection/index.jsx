...
import { contactConfig } from '@/dataContent/contact_option';
  ...
  return (
    <div class="container my-24 mx-auto md:px-6">
      ...
      <div class="container px-6 md:px-12">
        <div
          class="block rounded-lgbg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
          <div class="flex flex-wrap items-center">
            <div class="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
              <div class="h-[500px] w-full">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15767.019240734488!2d76.6829286!3d8.9023724!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05e325930dc415%3A0xfb139b7eaef985c4!2sActioplus%20Physiotherapy%20%26%20Pain%20Clinic!5e0!3m2!1sen!2sin!4v1688712644037!5m2!1sen!2sin"
                ...
                <div
                  ...
                  <div class="align-start flex">
                    ...
                    <div class="ml-6 grow">
                      ...
                      <p class="text-neutral-500 dark:text-neutral-200">
                      Actioplus Physiotherapy & Pain Clinic,
Vadakkemukku, Kannanalloor,Kollam, Kerala 691576
                      </p>
